...
void Task_VofaRx(void *argument) { //任务
    vofa_data_init();
    while (1) {
        vofa1.parse();                             // 解析收到的帧
        ...
        // vofa_update_if_changed(&Vafa_Speed,  0, &pid_speed._kp,  true);
        // vofa_update_if_changed(&Vafa_Speed,  1, &pid_speed._ki,  true);
        // vofa_update_if_changed(&Vafa_Speed,  2, &pid_speed._kd,  true);
        ...
        // vofa_update_if_changed(&Vafa_Location,  0, &pid_location._kp,  true);
        // vofa_update_if_changed(&Vafa_Location,  1, &pid_location._ki,  true);
        // vofa_update_if_changed(&Vafa_Location,  2, &pid_location._kd,  true);
